...
string defaultNoteCard = "Animazoo";
...
loadNoteCard() {
    ...
    // if the notecard name contains the word 'drunk' invoke the drunk cam script
    integer inebriated = llSubStringIndex(notecardName, "drunk");
    if(inebriated!=-1) llMessageLinked( LINK_THIS, 996633, "cam_drunk", NULL_KEY );
    else llMessageLinked( LINK_THIS, 996633, "cam_sober", NULL_KEY ); 
